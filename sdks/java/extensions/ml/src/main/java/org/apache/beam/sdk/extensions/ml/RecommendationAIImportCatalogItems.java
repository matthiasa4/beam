 ...
 *
 * <p>The transform consumes {@link KV} of  {@link String} and {@link GenericJson}s (assumed to be the catalog item
 * id as key and contents as value) and outputs a PCollectionTuple which will contain the successfully created and
 * failed catalog items.
 *
...
public abstract class RecommendationAIImportCatalogItems
    ...
    static class ImportCatalogItems
            extends DoFn<KV<String, Iterable<GenericJson>>, CatalogItem> {
        ...
        public void processElement(ProcessContext c) throws IOException {
            ...
            CatalogInlineSource catalogInlineSource = CatalogInlineSource
                    .newBuilder()
